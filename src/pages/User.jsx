...
function User() {
	...
	return (
		//<div className='w-full mx-auto lg:w-10'>{user.login}</div>
		<>
			<div className='w-full mx-auto lg:w-10/12'>
				<div className='mb-4'><Link to='/' className='btn btn-ghost'>back to search</Link>
				</div>
						...
						<div className='w-full rounded-lg shadow-md bg-base-100 stats'>
							...
							{twitter_username && (
								<div className='stat'>
									...
									<div className='text-lg stat-value'>
										<a href={`https://twitter.com/@${twitter_username}`} target='_blank' rel='noreferre'>
											{twitter_username}
										</a>
									</div>
								</div>
